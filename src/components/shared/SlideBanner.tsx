    ...
    <div className='center'>
      <div className='carousel-wrapper'>
        ...
        {Array(5)
          .fill(0)
          .map((_, index) => (
            <label key={index} htmlFor={`slide${index + 1}`} className='left-arrow'>
        ...
        {Array(5)
          .fill(0)
          .map((_, index) => (
            <label key={index} htmlFor={`slide${index + 1}`} className='right-arrow'>
        ...
        <div className='carousel'>
          <ul>
            {Array(5)
              ...
              .map((_, index) => (
                <li key={index}>
                  <Img src='/images/banner.png' alt='yolo-banner' layout='fill' />
                </li>
              ))}
          </ul>
        </div>
